...
const NotPaidOrdersTab: React.FC = () => {
  ...
  const totalCost = notPaidOrders?.reduce(
      ...
      <Table<newOrders>
        ...
        title={() => (
          <Flex align="center" justify="space-between" gap={24}>
            <div className="">
              <h1>
                Jami buyurtmalar: <b>{notPaidOrders?.length}</b>
              </h1>
              <h1>
...
export default NotPaidOrdersTab;
