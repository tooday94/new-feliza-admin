  ...
  return (
    <div>
      ...
      <Table
        ...
        dataSource={dataSource?.content.map((item, index) => ({
          ...item,
          key: index,
        }))}
        columns={[
                    ...
                    if (open) {
                      form.setFieldsValue(
                        record.productSizeVariantList.reduce(
                          (acc: Record<string, any>, variant, index) => {
                            acc[`quantity_${index}`] = variant.quantity;
                            return acc;
                          },
                  ...
                  onOpenChange={(open) => {
                    if (open) {
                      form.setFieldsValue(
                        record.productSizeVariantList.reduce(
                          (acc: Record<string, any>, variant, index) => {
                            acc[`barcode_${index}`] = variant.barCode;
                            return acc;
                          },
                          {}
                        )
