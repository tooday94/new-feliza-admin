      ...
      <div className="">
        ...
        >
          ...
          <Flex className="flex-wrap-reverse md:flex-wrap" gap={12}>
                  ...
                  ([color, variants]) => (
                    ...
                    >
                      <div className="border-b flex justify-between py-2 mb-2">
                        ...
                        <div className=" w-full flex justify-end items-center px-4 py-2 rounded-md">
                          <Button
                            onClick={showDrawer}
                            type="primary"
                            size="large"
                            className="hover:bg-blue-600 transition-colors duration-300 font-semibold"
                          >
                            Rang Tanlash
                          </Button>
                        </div>
                        ...
                        <div key={idx} className="">
                          ...
                          <div className="flex justify-between border-t mt-2 pt-2">
                            ...
                            <div>
                              <InputNumber
                                placeholder="Barcode"
                                value={v.barcode} // shu joy asosiy!
                                // readOnly // foydalanuvchi o‘zgartira olmasin (ixtiyoriy)
                                className="!w-full"
                              />
                            </div>
                          </div>
            ...
            {/*  comentdan chiqarilgan kod Form.Item toliq Colors bolim bu */}
            <Drawer
              width={600}
