    ...
    <div className="space-y-4">
      ...
      <div className="">
        ...
        >
          ...
          {/* Bu qismi ranglar va razmelar tanshlash  saytga qoshish qismi */}
          <Flex className="flex-wrap-reverse md:flex-wrap" gap={12}>
            {/* Left side - grouped products */}
              ...
              {(() => {
                ...
                return Object.entries(groupedByColor).map(
                  ([color, variants]) => (
                    <div
                      key={color}
                      className="border rounded-2xl shadow-md hover:shadow-lg transition-all bg-white p-4"
                    >
                      {/* Color Header */}
                      ...
                      {variants.map((v, idx) => (
                        <div
                          key={idx}
                          className="border rounded-lg p-3 mb-3 bg-gray-50 hover:bg-gray-100 transition-all"
                        >
                          ...
                          <div className="flex justify-between items-center border-t mt-3 pt-2">
                            <div className="flex gap-2 text-gray-700">
                              <p>Barcode:</p>
                              <span className="font-semibold">{v.barcode}</span>
                            </div>
                            <InputNumber
                              placeholder="Barcode"
                              value={v.barcode}
              ...
              <Form.Item
                ...
                label={
                  <Flex align="center" gap={10}>
                    <h1 className="font-semibold text-gray-700">Ranglar</h1>
                    <Button
                      title="Yangilash"
                      size="small"
                      icon={<ReloadOutlined />}
              ...
              >
                <Flex className="w-full">
                  <TreeSelect
                    ...
                    onChange={(val) =>
                      setSelectedSizes(val.map((v) => v.toUpperCase()))
                    }
                    tagRender={(props) => {
